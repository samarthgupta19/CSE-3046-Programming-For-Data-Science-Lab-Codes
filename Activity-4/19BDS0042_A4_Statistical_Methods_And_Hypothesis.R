...
# 9) Formulate the Null Hypothesis and Alternative Hypothesis for your data set and prove it based on the p-value.

data1 <- read.csv("https://raw.githubusercontent.com/samarthgupta19/CSE-3046-Programming-For-Data-Science-Lab-Codes/main/Activity-1/19BDS0042_metals_currencies_live_exchange_rates.csv")

# Read Data For "rates.LAK" On 28-08-2021 And 29-08-2021
data28 <- data1[data1$date == '28-08-2021',c(3,81)]
data29 <- data1[data1$date == '29-08-2021',c(3,81)]

# Null Hypothesis (H0) : There is no significant difference between the rates of "LAK" with respect to these two dates.
# Alternative Hypothesis (H1) : There is significant difference between the rates of "LAK" with respect to these two dates.

# Apply t-Test
result = t.test(sample(data28$rates.LAK,150), sample(data29$rates.LAK,150), var.equal = T)
result

# Observation : p-value > 0.05

# Conclusion : As the p-value > 0.05 , Null Hypothesis Is Significant And Is Accepted.
